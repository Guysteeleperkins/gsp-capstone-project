...
setup(
    name="gsp_capstone_project",
    version="0.1.0",
    description=("""An ETL project for extracting, transforming,
                 and loading data using my personal Garmin data in a CSV file"""),
    author="Your Name",
    author_email="guysteeleperkins@hotmail.com",
    url="https://github.com/Guysteeleperkins/gsp-capstone-project",
